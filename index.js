...
const APIKEY = sizey_api_data.APIKEY || document.querySelector("#sizey-container").getAttribute("APIKEY") || 'TzQzeGZXOU5CQ0RSS1N4TEhyb1k6bTlDNEttUVM=';
 ...
 */
const RECOMMENDATION_LINK_TEXT = sizey_api_data.RECOMMENDATION_LINK_TEXT || document.querySelector("#sizey-container").getAttribute("RECOMMENDATION_LINK_TEXT") || "Test your size"; 
const RECOMMENDATION_BUTTON_TEXT = sizey_api_data.RECOMMENDATION_BUTTON_TEXT || document.querySelector("#sizey-container").getAttribute("RECOMMENDATION_BUTTON_TEXT") || "Test My Size"; 
